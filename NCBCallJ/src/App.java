public class App {
    public static void main(String[] args) throws Exception {
        ...
        String data = "getFlexTransInfoById^tult-FLEX-TEST9443C14*BIEN2";
        String data2 = "nopRutTienNHNN^ID.FLEX1141*USER1*USER2*VND12501000100011*VND*50000000*20230909*500000000224*CN Ha noi Thuc hien rut tien mat tu NHNN Thuc hien rut tien mat tu NHNN*Thuc hien rut tien mat tu NHNN Thuc hien rut tien mat tu NHNN Thuc hien rut tien mat tu NHNN*9001*VN0010001";
